...
public sealed class CreateNewTokenByRefreshTokenCommandHandler : IRequestHandler<CreateNewTokenByRefreshTokenCommand, LoginCommandResponse>
{
    ...
    async Task<LoginCommandResponse> IRequestHandler<CreateNewTokenByRefreshTokenCommand, LoginCommandResponse>.Handle(CreateNewTokenByRefreshTokenCommand request, CancellationToken cancellationToken)
    {
